...
<body>
    ...
    <script>
        const BOT_TOKEN = '7887042344:AAH0Vd9SKrVkL5SW12nXvd5XkFr8nUfmxdM'; // Замените на токен вашего бота
        const ADMIN_CHAT_ID = '5829497598'; // Замените на ID администратора
